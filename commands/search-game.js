...
module.exports = {
  ...
  async execute(interaction, client) {
	...
	if (platform === '3ds') {
		url = "https://raw.githubusercontent.com/ghost-land/ghost-land.github.io/main/ghosteshop.json"
	}
	else if (platform === 'nds') {
		url = "https://raw.githubusercontent.com/ghost-land/ghost-land.github.io/main/ghosteshop-ds.json"
	}
          ...
          if (data[i].info.title.toLowerCase().includes(game.toLowerCase())) {
            ...
            const embed = new EmbedBuilder()
			  ...
			  .addFields({
				...
				name: "Console",
				value: data[i].info.console ? data[i].info.console : "Unknown",
			  },{
				name: "Category",
				value: data[i].info.category ? data[i].info.category : "Unknown",
			  })
